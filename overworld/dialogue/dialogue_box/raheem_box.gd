...
@onready var character_label: Sprite2D = %CharacterLabel
...
var dialogue_line: DialogueLine:
	set(next_dialogue_line):
		...
		if not dialogue_line.character.is_empty():
			character_label.texture = ResourceLoader.load("res://overworld/dialogue/dialogue_box/" + dialogue_line.character + " title.png")
