...
const warnScene = preload("res://minigames/karl_pilkington/assets/enemies/monika/warning.tscn")
const MAX_WARN_TIMER = Vector2i(11, 20)
var warn_timer = rng.randi_range(MAX_WARN_TIMER.x, MAX_WARN_TIMER.y)

const deadFlowerScene = preload("res://minigames/karl_pilkington/assets/enemies/monika/dead_flower.tscn")
