...
enum AnimationsIn {NONE, POP_IN, RAHEEM_STANDARD, FADE_UP}
...
@export var text_custom_color: Color = Color.BLACK
...
func _apply_export_overrides() -> void:
	...
	## BOX SETTINGS
	var dialog_text_panel: TextureRect = %DialogTextPanel
	...
	if get_node_or_null("$Anchor/AnimationParent/Sizer/DialogTextPanel/NameLabelHolder/NameLabelPanel/NameHolder"):
