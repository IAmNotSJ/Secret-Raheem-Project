...
## Chain-able
func set_username(username: String) -> DiscordWebHook:
...
## Chain-able
func set_tts(tts: bool) -> DiscordWebHook:
	data["tts"] = tts
	return self
...
func thread(name: String, _applied_tags: PackedStringArray = []) -> DiscordWebHook:
